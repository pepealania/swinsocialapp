...
{
    internal class ProfilesPageMaybeViewModel : BasePageViewModel
    {
        ...
        public ProfilesPageMaybeViewModel(INavigation navigation,ProfileEntity p)
        {
        ...
        public ObservableCollection<ProfileEntity> ProfilesMaybe
        {
            get => _profilesliked;
            set
            {
        ...
        private async void InitializeProfiles(ProfileEntity p)
        {
            ...
            List<ProfileEntity> profiles = await mock.LoadMaybeProfiles(p);

            foreach (var item in profiles)
            {
                ProfilesMaybe.Add(item);
            }
        }
