...
{
    internal class ProfilesPageLikedViewModel : BasePageViewModel
    {
        ...
        public ProfilesPageLikedViewModel(INavigation navigation,ProfileEntity p)
        {
        ...
        public ObservableCollection<ProfileEntity> ProfilesLiked
        {
            get => _profilesliked;
            set
            {
        ...
        private async void InitializeProfiles(ProfileEntity p)
        {
            ...
            List<ProfileEntity> profiles = await mock.LoadLikedProfiles(p);

            foreach (var item in profiles)
            {
                ProfilesLiked.Add(item);
            }
        }
