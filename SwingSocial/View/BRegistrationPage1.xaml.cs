...
{
    public partial class BRegistrationPage1 : ContentPage
    {
        ...
        private async void TapGestureRecognizer_TappedConfirmBox(object sender, EventArgs e)
        {
            ...
            var result = u.SendEmail(EmailEntry.Text);

            var secondPage = new BRegistrationPage2(EmailEntry.Text);
        ...
        private async void OpenConfirmation_Tapped(object sender, EventArgs e)
        {
            ...
            {
                EmailEntry.Focus();
                await DisplayAlert("Registration Status", "Write a valid Email address.", "ok");
            }
        }
    }
}