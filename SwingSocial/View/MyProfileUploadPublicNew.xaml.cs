...
{
    public partial class MyProfileUploadPublicNew : ContentPage
    {
        ...
        public MyProfileUploadPublicNew(int order,System.IO.Stream streamToCrop, System.IO.Stream streamToCrop2, System.IO.Stream streamToCrop3, System.IO.Stream streamToCrop4)
        {
            InitializeComponent();
        ...
        private void CropButton_OnClicked(object sender, EventArgs e)
        {
            ...
            Navigation.PushAsync(new MyProfileUploadPublicCrop(_order,image, imageName, (System.IO.Stream)imageStream));
        }
