...
namespace SwingSocial.Sample.View
{
    public partial class MailPage : ContentPage
    {
        ...
        public static bool CommingFromWriteEmail { get; set; }
        public MailPage()
        {
            InitializeComponent();
        ...
        private async void Search_Clicked(object sender, EventArgs e)
        {
            ...
            //List<Profile> profiles = await mock.LoadSearchedUserProfiles(conversationText);
            //ChatViewModel.Profiles = new System.Collections.ObjectModel.ObservableCollection<Profile>();
        ...
        private async void myprofilesemailList_ItemTapped(object sender, ItemTappedEventArgs e)
        {
