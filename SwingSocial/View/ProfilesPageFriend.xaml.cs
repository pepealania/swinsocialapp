...
namespace SwingSocial.Sample.View
{
    ...
    public partial class ProfilesPageFriend : ContentPage
    {
        public static Location location;
        string currentPineapple= "pineapple.gif";
        public static ProfileEntity currentSwipeProfile;
        public ProfilesPageFriend(ProfileEntity p)
        {
            try
            {
                InitializeComponent();
                BindingContext = new ProfilesPageLikedViewModel(Navigation,p);
        ...
        private void OnDragging(object sender, DraggingCardEventArgs e)
        {
            ...
            var threshold = (BindingContext as ProfilesPageLikedViewModel).Threshold;
