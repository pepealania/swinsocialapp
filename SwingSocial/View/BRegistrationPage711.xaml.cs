...
{
    public partial class BRegistrationPage711 : ContentPage
    {
        ...
        public BRegistrationPage711(ProfileEntity p,FileStream fileStream)
        {
            InitializeComponent();
            cpviewmodel = new CropViewModel();//= new NewAccountViewModel(Navigation);
            BindingContext = cpviewmodel;
            cpviewmodel.ImageUrl = p.Avatar;
            imageStreamAvatar = fileStream;
        }
        ...
        private async void SfImageEditor_ImageSaved(object sender, Syncfusion.SfImageEditor.XForms.ImageSavedEventArgs args)
        {
            ...
            {
                UploadAvatarFileToFTP(fileStream);
            }
