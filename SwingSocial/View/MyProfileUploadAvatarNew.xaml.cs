...
{
    public partial class MyProfileUploadAvatarNew : ContentPage
    {
        ...
        public MyProfileUploadAvatarNew()
        {
            InitializeComponent();
        ...
        private void CropButton_OnClicked(object sender, EventArgs e)
        {
            ...
            Navigation.PushAsync(new MyProfileUploadAvatarCrop(image, imageName, (System.IO.Stream)imageStream));
        }
