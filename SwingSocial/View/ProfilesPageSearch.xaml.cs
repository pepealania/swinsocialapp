...
namespace SwingSocial.Sample.View
{
    ...
    public partial class ProfileSearchedDetailsPage : ContentPage
    {
        public static Location location;
        string currentPineapple= "pineapple.gif";
        public static ProfileEntity currentSwipeProfile;
        public ProfileSearchedDetailsPage(ProfileEntity p)
        {
            try
            {
                InitializeComponent();
                BindingContext = new ProfileSearchedDetailsViewModel(Navigation,p,this);
        ...
        private void OnDragging(object sender, DraggingCardEventArgs e)
        {
            ...
            var threshold = (BindingContext as ProfileSearchedDetailsViewModel).Threshold;
