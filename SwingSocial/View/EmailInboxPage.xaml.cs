...
{
    public partial class EmailInboxPage : ContentPage
    {
        string currentPineapple = "pineapple.gif";
        public static string ToProfileId;
        static EmailViewModel ChatViewModel { get; set; }
        public EmailInboxPage()
        {
            InitializeComponent();
            ChatViewModel = new EmailViewModel(Navigation);
        ...
        {
            myprofileschatList.ScrollTo(ChatViewModel.ChatComments[ChatViewModel.ChatComments.Count - 1], ScrollToPosition.End, true);
        }
