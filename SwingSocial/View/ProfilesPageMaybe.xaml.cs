...
namespace SwingSocial.Sample.View
{
    ...
    public partial class ProfilesPageMaybe : ContentPage
    {
        public static Location location;
        string currentPineapple= "pineapple.gif";
        public static ProfileEntity currentSwipeProfile;
        public ProfilesPageMaybe(ProfileEntity p)
        {
            try
            {
                InitializeComponent();
                BindingContext = new ProfilesPageMaybeViewModel(Navigation,p);
        ...
        private void OnDragging(object sender, DraggingCardEventArgs e)
        {
            ...
            var threshold = (BindingContext as ProfilesPageMaybeViewModel).Threshold;
