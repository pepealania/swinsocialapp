...
namespace SwingSocial.Sample.View
{
    ...
    public partial class ProfilesPageOnline : ContentPage
    {
        public static Location location;
        string currentPineapple= "pineapple.gif";
        public static ProfileEntity currentSwipeProfile;
        public ProfilesPageOnline(ProfileEntity p)
        {
            try
            {
                InitializeComponent();
                BindingContext = new ProfilesPageOnlineViewModel(Navigation,p);
        ...
        private void OnDragging(object sender, DraggingCardEventArgs e)
        {
            ...
            var threshold = (BindingContext as ProfilesPageOnlineViewModel).Threshold;
