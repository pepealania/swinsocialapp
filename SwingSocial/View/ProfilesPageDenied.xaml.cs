...
namespace SwingSocial.Sample.View
{
    ...
    public partial class ProfilesPageDenied : ContentPage
    {
        public static Location location;
        string currentPineapple= "pineapple.gif";
        public static ProfileEntity currentSwipeProfile;
        public ProfilesPageDenied(ProfileEntity p)
        {
            try
            {
                InitializeComponent();
                BindingContext = new ProfilesPageDeniedViewModel(Navigation,p);
        ...
        private void OnDragging(object sender, DraggingCardEventArgs e)
        {
            ...
            var threshold = (BindingContext as ProfilesPageDeniedViewModel).Threshold;
