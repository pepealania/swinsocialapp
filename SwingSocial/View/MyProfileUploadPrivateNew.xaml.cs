...
{
    public partial class MyProfileUploadPrivateNew : ContentPage
    {
        ...
        public MyProfileUploadPrivateNew(int order,System.IO.Stream streamToCrop, System.IO.Stream streamToCrop2, System.IO.Stream streamToCrop3, System.IO.Stream streamToCrop4)
        {
            InitializeComponent();
            ...
            PickedFile(streamToCrop, streamToCrop2, streamToCrop3, streamToCrop4);
            _order = order;
        }
        async void PickedFile(System.IO.Stream streamToCrop, System.IO.Stream streamToCrop2, System.IO.Stream streamToCrop3, System.IO.Stream streamToCrop4)
        {
            try
            {
                if (streamToCrop != null)
                {
                    var stream = streamToCrop;
                    var stream2 = streamToCrop2;
                    var stream3 = streamToCrop3;
                    var stream4 = streamToCrop4;
                    imageStream = stream;
        ...
        private void CropButton_OnClicked(object sender, EventArgs e)
        {
            ...
            Navigation.PushAsync(new MyProfileUploadPrivateCrop(_order,image, imageName, (System.IO.Stream)imageStream));
        }
