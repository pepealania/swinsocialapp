...
{
    public partial class EmailReviewPage : ContentPage
    {
        ...
        public static bool CommingFromEmailReview { get; set; }
        public EmailReviewPage(Email email)
        {
            InitializeComponent();
        ...
        private void YesFriends_Clicked(object sender, EventArgs e)
        {
        ...
        {
            ProfilePrivate p = new ProfilePrivate();
            p.LoginIdProfileId = SwipeCardView.UsrId.ToString();
            p.TargetProfileId = CurrentEmail.ProfileTo;
            UsersMock um = new UsersMock();
            var result = um.ImageGrantPrivateAccess(p);
