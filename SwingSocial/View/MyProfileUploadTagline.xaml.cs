...
{
    public partial class MyProfileUploadTagline : ContentPage
    {
        ...
        {
            newProfile.Tagline = taglineEditor.Text;
            MyProfileService myProfileService = new MyProfileService();
            var result = await myProfileService.EditProfileTagline(newProfile);
            await DisplayAlert("Update Status", "Tagline successfully updated.", "ok");
