...
namespace SwingSocial.Sample.Helper
{
    ...
    {
        public static List<Event> AddExtraInfo(this List<Event> events)
        {
            List<Event> eventsOut = new List<Event>();
